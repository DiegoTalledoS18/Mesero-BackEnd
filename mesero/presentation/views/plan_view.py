...
class PlanUpdateView(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            locations = int(
                locations_str) if locations_str else plan.locations  # Si "quantity" es vacío, usa el valor actual
        except ValueError:
        ...
        try:
            tables = int(
                tables_str) if tables_str else plan.tables  # Si "quantity" es vacío, usa el valor actual
        except ValueError:
        ...
        try:
            updated_plan = use_case.execute(plan_id, name, description, locations, tables, price)
